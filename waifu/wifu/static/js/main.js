...
const username = helpers.getURLParam("username") || "kat";
...
console.log("Speech recognition engine:", speechRecognitionEngine);
...
if (usawServerURL) {
    ...
    console.log("AI function calling main.js line 135");

    ai = new APIAbuserAI(openAIKey, messages);
} else {
    ai = new AI();
}
...
console.log("TTS engine selected:", voiceEngine);
